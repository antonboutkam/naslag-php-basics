...
// Vraag: Waarom zie je niets op het scherm als je dit uitvoert?
ikBenLuiVandaag('Vul je naam in');
ikVerdienEenStikker('Vul je naam in');
eerlijkeBeoordeling('Vul je naam in');
